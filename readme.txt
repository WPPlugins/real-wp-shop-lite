...
For documentation go here: [DOCUMENTATION](http://jultranet.com/wp/rwpslitedocs/index.html)
...
Fixed a CSS bug on "payment options" page that appeared on the latest version of WordPress and messed up the layout on the page.
